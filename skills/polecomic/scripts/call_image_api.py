...
激活虚拟环境：conda activate HuesaeAgents
...
# ══════════════════════════════════════════════════════
ARK_API_KEY     = os.getenv("DOUBAO_SEEDREAM_API_KEY")
# ARK_IMAGE_MODEL = "doubao-seedream-5-0-260128"DOUBAO_SEEDREAM_MODEL_NAME
ARK_IMAGE_MODEL = os.getenv("DOUBAO_SEEDREAM_MODEL_NAME")
